...
import { getGagnants } from 'src/servicesApi/gagnants'
...
const Gagnants = () => {
  const { data } = useQuery('gagnants', () => getGagnants())
  const gagnants = data ?? []
  ...
  return (
    <>
      <Typography variant='h4'>Les Gagnants</Typography>
      <Typography variant='h5'>
        {' '}
        The Wheel / <span style={{ color: 'red' }}>Gagnants</span>{' '}
      </Typography>
      <Card sx={{ height: '80%' }}>
        <CardContent>
