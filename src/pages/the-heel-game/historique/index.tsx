...
const CLients = () => {
  ...
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, history?.history?.length - page * rowsPerPage)
        ...
        <CardContent>
          <TableContainer component={Paper}>
            <Table stickyHeader aria-label='sticky table'>
              ...
              <TableBody>
                {history?.history?.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row: any) => (
